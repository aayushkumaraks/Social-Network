...
if($_SESSION['auth']=='mod'){
    $contacts = "SELECT * FROM `user` WHERE `user`.`auth`='user'";
}
else{
    $contacts = "SELECT * FROM `user` WHERE `user`.`auth`='user' OR `user`.`auth`='mod'";
}
$fetch_Cont = mysqli_query($conn, $contacts);

if(isset($_POST['deluser'])){
    $uid = $_POST['uid'];
    $del_q = "DELETE FROM `user` WHERE `user`.`sid` = '$uid'";
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <button class="btn btn-danger form-control" name="deluser"><i class="fa fa-times-circle"></i> Delete</button>
                                </form>
                            </td>
                        </tr>
